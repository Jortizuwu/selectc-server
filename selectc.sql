...
--
-- Servidor: localhost
-- Tiempo de generación: 05-06-2023 a las 03:31:38
...
CREATE TABLE `career` (
  ...
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `facultyID` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL
...
CREATE TABLE `faculty` (
  `facultyID` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `faculty` (`facultyID`, `name`, `createdAt`, `updatedAt`) VALUES
('1165122f-de23-4655-8b0b-a54caefa342c', 'Educacion', '2023-05-26 17:16:42', '2023-05-26 17:16:42'),
('51ffc168-da25-4266-b023-a2444192c1d6', 'Ciencias de la Salud', '2023-05-26 17:16:42', '2023-05-26 17:16:42'),
('612838de-5a47-405e-8e52-24962eecfbde', 'Ciencias Economicas y Juridicas', '2023-05-26 17:16:42', '2023-05-26 17:16:42'),
('7c943875-581f-4d9e-a941-4c5abad59bba', 'Ciencias Basicas', '2023-05-26 17:16:42', '2023-05-26 17:16:42'),
('afff605c-59fa-492e-ab6b-9f44eb9cef0e', 'Agronoma', '2023-05-26 17:16:42', '2023-05-26 17:16:42'),
('f92ce424-6718-4322-a876-e63a978e36a5', 'Ingenieria', '2023-05-26 17:16:42', '2023-05-26 17:16:42');
...
CREATE TABLE `user` (
  ...
  `preferenceCareer` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `user` (`uid`, `name`, `lastName`, `email`, `password`, `age`, `gender`, `income`, `createdAt`, `updatedAt`, `roleID`, `statusID`, `schoolID`, `preferenceCareer`) VALUES
('29dc1cc4-6d99-4cca-a1d6-33b497ce725e', 'Jose', 'Ortiz', 'joseher2511@gmail.com', '$2a$10$vjHypj96TRaL2Q7IB7HYxuxeK8l9B3An.DRezkNMHGPdQfvOFrlJe', 11, '', 0, '2023-03-21 23:12:29', '2023-04-24 14:16:56', 'f2e17c05-c2b7-11ed-8f01-60f26226b94d', '2c19e09a-c2b8-11ed-8f01-60f26226b9ad', 'df6dbc4f-31ee-4bad-a884-ba156aff1925', 'Administracion en Finanzas y Negocios Internacionales'),
('37bbf90e-2470-4d6c-b784-ecf69f971245', 'jojouwu', 'uwu', 'jojouwu25@gmail.com', '$2a$10$CtrbYRWKg5An3OJc2dgY5e0ljFagii7NfBhofOz83VQAWrCVp4hg2', NULL, NULL, NULL, '2023-05-06 18:12:15', '2023-05-06 18:12:15', 'f2e1640d-c2b7-11ed-8f01-60f26226b24d', '2c19e09a-c2b8-11ed-8f01-60f26226b9ad', 'df6dbc4f-31ee-4bad-a884-ba156aff1925', 'Ingeniería de Sistemas'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', 'jojo', 'ortiz', 'jose@jose.com', '$2a$10$qXd4R7RsFl7fo9ET3YGIbeZRI4lshEDINE4VcHS8MyQX.gld2WEWu', 11, '', 0, '2023-04-24 14:30:35', '2023-05-26 19:16:40', 'f2e1640d-c2b7-11ed-8f01-60f26226b24d', '2c19e09a-c2b8-11ed-8f01-60f26226b9ad', 'df6dbc4f-31ee-4bad-a884-ba156aff1925', 'Administracion en Finanzas y Negocios Internacionales'),
('d91188cf-1d96-4227-acb3-a6c3010d1156', 'pepito', 'pepito', 'pepito@pepito.com', '$2a$10$ZsjQqBbOGlqAnPgdEiVMT.X5FoWYhYKNH9J6dHJqRJBG2lI4Fcvqu', 11, '', 0, '2023-04-24 14:44:03', '2023-05-26 19:18:45', 'f2e1640d-c2b7-11ed-8f01-60f26226b24d', '2c19e09a-c2b8-11ed-8f01-60f26226b9ad', 'df6dbc4f-31ee-4bad-a884-ba156aff1925', 'Administracion en Finanzas y Negocios Internacionales');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `user_has_activity`
--
...
--
-- Volcado de datos para la tabla `user_has_activity`
--
...
(12, '2023-05-26 19:16:18', '2023-05-26 19:16:18', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', '21d2256c-5275-4421-8092-9e4058b5419c'),
(12, '2023-05-26 19:16:18', '2023-05-26 19:16:18', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', '3e926b68-5300-4a25-80e6-60181b16b8c9'),
(10, '2023-05-26 19:16:18', '2023-05-26 19:16:18', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', '5384ddf6-51ea-48f1-a67e-8a00f929e4e5'),
(10, '2023-05-26 19:16:18', '2023-05-26 19:16:18', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', '5613a5dd-91fa-4715-87fb-e2a44fbbe770'),
(10, '2023-05-26 19:16:18', '2023-05-26 19:16:18', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', '756a5522-efbc-41ac-ac4c-c9c80af7b60c'),
(10, '2023-05-26 19:16:18', '2023-05-26 19:16:18', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', 'bf9d75b8-1083-41e8-8869-3a01513ced63'),
(12, '2023-05-26 19:16:18', '2023-05-26 19:16:18', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', 'ff5b5f92-7ca0-4693-baa7-2fa61c50bcb8'),
...
--
-- Estructura de tabla para la tabla `user_has_career`
--
...
--
-- Volcado de datos para la tabla `user_has_career`
--
...
(0.9164073467254639, '2023-05-26 19:16:20', '2023-05-26 19:16:20', '9b80f73a-b789-4a47-b9b1-64445bcf08c8', '1f6426ca-9ca6-40d1-b7bf-f08ce59ec1e6'),
(0.9202433228492737, '2023-05-26 19:19:00', '2023-05-26 19:19:00', 'd91188cf-1d96-4227-acb3-a6c3010d1156', '1f6426ca-9ca6-40d1-b7bf-f08ce59ec1e6');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `user_has_preference`
--
...
--
-- Volcado de datos para la tabla `user_has_preference`
--
...
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '0556669d-df07-4de6-8e02-cd170274f3ae', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '1ec5c69f-deb3-40a6-a9a2-6ed22e13f738', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '33a0a463-8984-4162-8029-216b7b1c4a9b', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '5c28a57f-5e3e-4f1c-a503-a10958173f50', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '646af121-91cc-44a3-ad44-45df112d9249', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '8b73bd99-1c3d-4673-96fe-10b335d57624', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '96be7631-545a-4644-8d81-3acdd694b9ac', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', '9fb9cda2-1fa3-440a-b82f-6f7f6f2379b0', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', 'a3c06889-00cb-4fe6-9360-73b483dbb8af', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', 'c90575ce-72e3-4002-aa28-76a1ccd2b10a', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
('9b80f73a-b789-4a47-b9b1-64445bcf08c8', 'cdde8106-e13d-494b-ba2a-147ce22fea1f', '2023-05-26 19:15:16', '2023-05-26 19:15:16'),
...
ALTER TABLE `status`
  ...
  ADD UNIQUE KEY `statusCode_5` (`statusCode`),
  ADD UNIQUE KEY `statusCode_6` (`statusCode`),
  ADD UNIQUE KEY `statusCode_7` (`statusCode`),
  ADD UNIQUE KEY `statusCode_8` (`statusCode`),
  ADD UNIQUE KEY `statusCode_9` (`statusCode`),
  ADD UNIQUE KEY `statusCode_10` (`statusCode`),
  ADD UNIQUE KEY `statusCode_11` (`statusCode`),
  ADD UNIQUE KEY `statusCode_12` (`statusCode`),
  ADD UNIQUE KEY `statusCode_13` (`statusCode`),
  ADD UNIQUE KEY `statusCode_14` (`statusCode`),
  ADD UNIQUE KEY `statusCode_15` (`statusCode`),
  ADD UNIQUE KEY `statusCode_16` (`statusCode`),
  ADD UNIQUE KEY `statusCode_17` (`statusCode`),
  ADD UNIQUE KEY `statusCode_18` (`statusCode`),
  ADD UNIQUE KEY `statusCode_19` (`statusCode`),
  ADD UNIQUE KEY `statusCode_20` (`statusCode`),
  ADD UNIQUE KEY `statusCode_21` (`statusCode`),
  ADD UNIQUE KEY `statusCode_22` (`statusCode`),
  ADD UNIQUE KEY `statusCode_23` (`statusCode`),
  ADD UNIQUE KEY `statusCode_24` (`statusCode`),
  ADD UNIQUE KEY `statusCode_25` (`statusCode`),
  ADD UNIQUE KEY `statusCode_26` (`statusCode`),
  ADD UNIQUE KEY `statusCode_27` (`statusCode`),
  ADD UNIQUE KEY `statusCode_28` (`statusCode`),
  ADD UNIQUE KEY `statusCode_29` (`statusCode`),
  ADD UNIQUE KEY `statusCode_30` (`statusCode`),
  ADD UNIQUE KEY `statusCode_31` (`statusCode`),
  ADD UNIQUE KEY `statusCode_32` (`statusCode`),
  ADD UNIQUE KEY `statusCode_33` (`statusCode`),
  ADD UNIQUE KEY `statusCode_34` (`statusCode`),
  ADD UNIQUE KEY `statusCode_35` (`statusCode`),
  ADD UNIQUE KEY `statusCode_36` (`statusCode`),
  ADD UNIQUE KEY `statusCode_37` (`statusCode`),
  ADD UNIQUE KEY `statusCode_38` (`statusCode`),
  ADD UNIQUE KEY `statusCode_39` (`statusCode`),
  ADD UNIQUE KEY `statusCode_40` (`statusCode`),
  ADD UNIQUE KEY `statusCode_41` (`statusCode`),
  ADD UNIQUE KEY `statusCode_42` (`statusCode`),
  ADD UNIQUE KEY `statusCode_43` (`statusCode`);
...
--
-- Indices de la tabla `user_has_activity`
--
...
--
-- Indices de la tabla `user_has_career`
--
...
--
-- Indices de la tabla `user_has_preference`
--
...
--
ALTER TABLE `career`
  ADD CONSTRAINT `career_ibfk_1` FOREIGN KEY (`facultyID`) REFERENCES `faculty` (`facultyID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_118` FOREIGN KEY (`roleID`) REFERENCES `role` (`roleID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `user_ibfk_119` FOREIGN KEY (`statusID`) REFERENCES `status` (`statusID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `user_ibfk_120` FOREIGN KEY (`schoolID`) REFERENCES `school` (`schoolID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `user_has_activity`
--
ALTER TABLE `user_has_activity`
...
--
-- Filtros para la tabla `user_has_career`
--
ALTER TABLE `user_has_career`
...
--
-- Filtros para la tabla `user_has_preference`
--
ALTER TABLE `user_has_preference`
